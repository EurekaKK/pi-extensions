...
export const GOAL_POLICY_GUIDELINE =
	...
	"Mark complete only when the objective is actually achieved. Mark blocked only after the same blocking condition persists " +
	"for at least the configured number of consecutive goal rounds, and report that concrete condition in blocked_reason.";
